...
export const getDataSheetsBySubFactionIdAndBattlefieldRoleIdAsync = async (subFactionId: string | number, battlefieldRoleId: string | number) =>
  Fetch<buildr.DataSheet[]>(`/api/sub-faction/${subFactionId}/datasheets/by-battlefield-role/${battlefieldRoleId}`, { method: 'GET' });
